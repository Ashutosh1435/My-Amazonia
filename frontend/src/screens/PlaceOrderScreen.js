...
function PlaceOrderScreen(props) {
    ...
    cart.itemsPrice = toPrice(
        //  array reduce method to convert a array values in single value.
    ...
    const PlaceOrderHandler = () => {
        ...
        // Here spread cart first, and then replace cartItems with orderItems. 
                ...
                <div className="col-1">
                    <div className="card-body card">
                        <ul>
                            ...
                            <li>
                                <div className="row">
                                    {/* Use strong to make text bold(Important) */}
                                    <div><strong>Ordrer Total</strong></div>
